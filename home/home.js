...
fetch("http://localhost:3000/products")
  ...
  .then(function (res) {
    console.log("iam the data stored in the databse", res);
  })
  .catch(function (err) {
    console.log("iam excuted beacuse there is an error while making a request");
  })
  .finally(function () {
    console.log("iam excuted even if the request succesfull or error");
  });
